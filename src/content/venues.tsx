  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          tabName: 'Кто наши участники',
          title: 'IT-специалисты всех направлений',
          text: 'Наши участники — разработчики, деврелы, аналитики, тестировщики и другие IT-специалисты, которым близка неформальная атмосфера. Дринкап популярен: собираем ~150 регистраций, подтверждаем участие по вместимости площадки.',
          list: [
            {
            ...
            },
            {
              ...
              text: 'Средний чек — ~2500 ₽ на человека, полная посадка в четверг.',
            },
            {
