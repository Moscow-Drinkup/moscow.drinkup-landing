...
function setTermAttrs(token, termKey, generateID) {
 ...
 */
function termInlineRuleFactory(generateID) {
    return function termInlineRule(state, silent) {
...
const term = (md, options) => {
    ...
    const generateID = (_a = options.generateID) !== null && _a !== void 0 ? _a : utils_1.generateID;
