...
function termReplace(str, env, escape, generateID) {
    ...
    const termCode = str.replace(reg, (_match, p1, _p2, p3) => `<i class="yfm yfm-term_title" term-key=":${p3}" id="${generateID(p3)}">${p1}</i>`);
    return termCode || str;
}
 ...
 */
function balanceSpansPerLine(lines) {
    const openTagStack = [];
 ...
 */
function stripPrompt(content, prompt) {
...
function postProcessCode(code, { showLineNumbers, lineWrapping, promptFlags, promptEscaped, }) {
    ...
    return (normalized
        ...
        if ((promptFlags === null || promptFlags === void 0 ? void 0 : promptFlags[index]) && promptEscaped !== undefined) {
            const trimmed = line.trimStart();
            const leadingWs = line.slice(0, line.length - trimmed.length);
            line =
                `${leadingWs}` +
...
function parseFenceInfo(info) {
    ...
    const prompt = (_a = promptMatch === null || promptMatch === void 0 ? void 0 : promptMatch[1]) !== null && _a !== void 0 ? _a : promptMatch === null || promptMatch === void 0 ? void 0 : promptMatch[2];
...
const code = (md, opts) => {
    ...
    const generateID = (_a = opts === null || opts === void 0 ? void 0 : opts.generateID) !== null && _a !== void 0 ? _a : utils_2.generateID;
    ...
    md.renderer.rules.fence = function (tokens, idx, options, env, self) {
        ...
        if (prompt) {
            ...
            promptEscaped = (0, utils_1.escapeHtml)(prompt);
        }
        ...
        if (superCode && (prompt || shouldWrap)) {
            superCode = superCode.replace(/(<pre[^>]*><code)([^>]*)>/, (_match, open, attrs) => {
                ...
                if (prompt) {
                    attrs = ` data-prompt="${(0, utils_1.escapeHtml)(prompt)}"${attrs}`;
                }
                return `${open}${attrs}>`;
            });
        }
