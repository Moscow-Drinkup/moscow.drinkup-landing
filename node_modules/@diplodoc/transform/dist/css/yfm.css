...
.yfm-code-floating-container .yfm-code-button {
  ...
  font: inherit;
  cursor: pointer;
  transition: opacity 0.1s ease-out, color 0.15s linear;
}
...
.yfm-code-floating-container .yfm-code-prompt {
...
.yfm table th.cell-align-top-left,
.yfm table th.cell-align-bottom-left,
.yfm table td.cell-align-top-left,
.yfm table td.cell-align-bottom-left {
  text-align: start;
}
.yfm table th.cell-align-top-center,
.yfm table th.cell-align-center,
.yfm table td.cell-align-top-center,
.yfm table td.cell-align-center {
  text-align: center;
}
.yfm table th.cell-align-top-right,
.yfm table th.cell-align-bottom-right,
...
.yfm table tr[data-header] > th:not([class*=cell-bg-]),
.yfm table tr[data-header] > td:not([class*=cell-bg-]) {
