...
export type ContainerDirectiveHandler = (state: StateBlock, params: ContainerDirectiveParams) => boolean;
export type LeafBlockDirectiveHandler = (state: StateBlock, params: LeafBlockDirectiveParams) => boolean;
...
export type ContainerDirectiveConfig = {
    ...
    contentTokenizer?: (state: StateBlock, content: BlockContent, params: ContainerDirectiveParams) => void;
};
