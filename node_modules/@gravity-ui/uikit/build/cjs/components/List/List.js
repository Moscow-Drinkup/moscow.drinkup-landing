    ...
    renderSimpleContainer() {
        ...
        if (sortable) {
            return ((0, jsx_runtime_1.jsx)(dnd_1.DragDropContext, { onDragStart: this.onSortStart, onDragEnd: this.onSortEnd, children: (0, jsx_runtime_1.jsx)(dnd_1.Droppable, { droppableId: "droppable", renderClone: (provided, snapshot, rubric) => {
                    ...
                    }, children: (droppableProvided) => ((0, jsx_runtime_1.jsx)(components_1.SimpleContainer, { ref: this.refContainer, itemCount: items.length, provided: droppableProvided, onScrollToItem: this.props.onScrollToItem, role: role, id: this.props.id ?? this.uniqId, children: items.map((item, index) => {
                            const itemKey = this.getItemKey(item, index);
                            return ((0, jsx_runtime_1.jsx)(dnd_1.Draggable, { draggableId: itemKey, index: index, children: (provided, snapshot) => {
                                    return this.renderItem({
                                        index,
                                        isDragging: snapshot.isDragging,
                                        provided,
