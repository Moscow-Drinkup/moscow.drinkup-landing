...
const useInitialFocus_1 = require("../hooks/useInitialFocus.js");
...
const Drawer = (rawProps) => {
    const { open, onOpenChange, placement = 'left', children, contentClassName, resizable = false, size, minSize, maxSize, onResizeStart, onResizeEnd, onResize, className, style, qa, disableEscapeKeyDown, initialFocus, returnFocus, disableBodyScrollLock = false, contentOverflow = 'visible', disableVisuallyHiddenDismiss, onTransitionIn, onTransitionInComplete, onTransitionOut, onTransitionOutComplete, floatingRef, disablePortal, keepMounted = false, container, hideVeil = false, disableTransition = false, disableModal = false, ...restProps } = (0, useDefaultProps_1.useDefaultProps)('Drawer', rawProps);
    ...
    const { isMounted, status } = (0, useFloatingTransition_1.useFloatingTransition)({
        context,
        duration: disableTransition ? 0 : constants_1.DRAWER_ANIMATION_DURATION_MS,
        onTransitionIn,
        onTransitionInComplete,
        onTransitionOut,
        onTransitionOutComplete,
    });
    (0, useInitialFocus_1.useInitialFocus)({ open, initialFocus, floatingRef: refs.floating });
