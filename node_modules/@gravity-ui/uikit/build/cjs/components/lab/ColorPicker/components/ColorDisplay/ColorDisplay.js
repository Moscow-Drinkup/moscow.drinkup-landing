...
exports.ColorDisplay = React.forwardRef(({ hsva, withAlpha, size = 'm', compact, disabled, onClick, onColorChange }, ref) => {
    ...
    const handleInputBlur = React.useCallback(() => {
        try {
            const newHsva = (0, utils_1.normalizeInputColorForMode)(inputValue, types_1.Modes.Hex, withAlpha).hsva;
    ...
    const swatch = ((0, jsx_runtime_1.jsx)("button", { type: "button", disabled: disabled, 
        // Always set a tabIndex so that Safari allows focusing native buttons
        tabIndex: disabled ? undefined : 0, className: (0, constants_1.b)('color-swatch', { size, disabled }), onClick: onClick, style: { backgroundColor: (0, react_color_1.hsvaToRgbaString)(hsva) } }));
    return ((0, jsx_runtime_1.jsx)("div", { className: (0, constants_1.b)('picker-wrapper', { compact, size, alpha: withAlpha }), ref: ref, children: (0, jsx_runtime_1.jsx)("div", { className: (0, constants_1.b)('picker-handlers'), children: compact ? (swatch) : ((0, jsx_runtime_1.jsx)(controls_1.TextInput, { disabled: disabled, size: size, startContent: swatch, value: inputValue, onChange: (e) => setInputValue(e.target.value), onBlur: handleInputBlur })) }) }));
});
