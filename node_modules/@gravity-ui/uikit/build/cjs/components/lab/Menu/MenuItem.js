...
exports.MenuItem = React.forwardRef((props, ref) => {
    const { theme, selected, disabled, icon, arrow, children, className, qa, component: _component, ...restComponentProps } = props;
    ...
    if (isMenuItemComponentProps(props)) {
        ...
        componentProps = {
            ...commonComponentProps,
            rel: (0, getLinkRelWithFallback_1.getLinkRelWithFallback)(props),
            'aria-disabled': disabled ?? undefined,
        };
    }
    else {
