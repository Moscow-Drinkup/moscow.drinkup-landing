...
exports.AccordionItem = React.forwardRef(function AccordionItem(props, _ref) {
    ...
    const disclosureExpanded = expanded !== undefined || defaultExpanded !== true ? isExpanded : undefined;
    const [preparedSummary, details] = React.useMemo(() => {
        return prepareChildren(children, qa);
    }, [children, qa]);
    return ((0, jsx_runtime_1.jsxs)(Disclosure_1.Disclosure, { arrowPosition: attributes?.arrowPosition, keepMounted: keepMounted, onUpdate: handleUpdate, expanded: disclosureExpanded, defaultExpanded: defaultExpanded, summary: summary, disabled: disabled, qa: qa, className: (0, constants_1.accordionItemBlock)({
