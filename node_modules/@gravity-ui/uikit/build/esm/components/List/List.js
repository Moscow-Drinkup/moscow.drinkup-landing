...
export class List extends React.Component {
    ...
    renderVirtualizedItem = ({ index, style, }) => {
        ...
        return (_jsx(Draggable, { draggableId: itemKey, index: index, children: (provided) => this.renderItem({ index, style, provided }) }, itemKey));
    };
    renderFilter() {
    ...
    renderSimpleContainer() {
        ...
        if (sortable) {
            return (_jsx(DragDropContext, { onDragStart: this.onSortStart, onDragEnd: this.onSortEnd, children: _jsx(Droppable, { droppableId: "droppable", renderClone: (provided, snapshot, rubric) => {
                    ...
                    }, children: (droppableProvided) => (_jsx(SimpleContainer, { ref: this.refContainer, itemCount: items.length, provided: droppableProvided, onScrollToItem: this.props.onScrollToItem, role: role, id: this.props.id ?? this.uniqId, children: items.map((item, index) => {
                            const itemKey = this.getItemKey(item, index);
                            return (_jsx(Draggable, { draggableId: itemKey, index: index, children: (provided, snapshot) => {
                                    return this.renderItem({
                                        index,
                                        isDragging: snapshot.isDragging,
                                        provided,
