...
import { isPolymorphicComponentProps } from "../utils/polymorphic.js";
...
const _Button = React.forwardRef(function Button(rawProps, ref) {
    ...
    if (typeof props.href !== 'undefined') {
        return (_jsx("a", { ...rest, ...extraProps, ...commonProps, ref: ref, rel: getLinkRelWithFallback(props), "aria-disabled": disabled ?? undefined, children: prepareChildren(children) }));
    }
