...
import "./Drawer.css";
export interface DrawerProps extends Omit<ModalProps, 'disableHeightTransition' | 'onClose' | 'onEscapeKeyDown' | 'onEnterKeyDown' | 'onOutsideClick'> {
    /**
...
export declare const Drawer: (rawProps: DrawerProps) => import("react/jsx-runtime").JSX.Element;
