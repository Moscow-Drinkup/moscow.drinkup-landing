...
function parseFooterDisclaimer(transformer, disclaimer) {
    return Object.assign(Object.assign({}, disclaimer), { text: transformer(disclaimer.text) });
}
...
exports.config = {
    ...
    [models_1.BlockType.FooterBlock]: [
        {
            fields: ['disclaimer'],
            transformer: common_1.yfmTransformer,
