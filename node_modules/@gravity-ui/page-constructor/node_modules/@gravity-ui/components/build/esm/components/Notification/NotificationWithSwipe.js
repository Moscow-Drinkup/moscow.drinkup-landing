...
import { HorizontalSwiper } from "./HorizontalSwiper/HorizontalSwiper.js";
...
export const NotificationWithSwipe = React.memo(function NotificationWithSwipe(props) {
    ...
    const [position, setPosition] = React.useState('notification');
    React.useEffect(() => {
    ...
    return (_jsx("div", { className: b('swipe-wrap'), children: _jsxs("div", { ref: ref, className: b('swipe', {
                ['has-left']: Boolean(leftAction),
                ['has-right']: Boolean(rightAction),
                position,
            }), children: [leftAction ? renderAction(leftAction) : null, _jsx("div", { className: notificationWrapperCls, children: _jsx(Notification, { notification: notification, wrapperRef: wrapperRef }) }), rightAction ? renderAction(rightAction) : null] }) }));
});
function renderAction(action) {
    return _jsx("div", { className: swipeActionContainerCls, children: action.content });
}
//# sourceMappingURL=NotificationWithSwipe.js.map
