...
import { DOUBLE_TAP_DELAY_MS, DOUBLE_TAP_DISTANCE_PX, DRAG_THRESHOLD_PX, MAX_SCALE_TOUCH, MIN_SCALE, } from "./constants.js";
/**
 ...
 */
export function useImageZoomTouch({ enabled, zoomState, zoomActions, constraints, onTap, }) {
     ...
     */
    const getTouchDistance = React.useCallback((touch1, touch2) => {
     ...
     */
    const isDoubleTap = React.useCallback((currentTime, currentPos) => {
...
//# sourceMappingURL=useImageZoomTouch.js.map
