...
import { TokenizedInputFieldProps as FieldProps, TokenizedInputSuggestionsProps as SuggestionsProps, TokenizedInputTokenProps as TokenProps } from "./components/index.js";
...
export type TokenPlaceholderGeneratorFn<T extends TokenValueBase> = (tokenType: 'new' | 'regular', tokenValue: T, idx: number) => string | undefined;
...
export type TokenizedInputOptionsInfo<T extends TokenValueBase> = {
    ...
    filterSuggestions: (items: TokenizedSuggestionsItem<T>[], search: string) => TokenizedSuggestionsItem<T>[];
};
export interface TokenizedInputData<T extends TokenValueBase> {
    ...
    /** Gets suggestions */
    onSuggest?: (suggestCtx: TokenizedSuggestionContext<T>) => TokenizedSuggestions<T> | Promise<TokenizedSuggestions<T>>;
    /** Render suggestions full width below the input */
    fullWidthSuggestions?: boolean;
    /** onFocus callback */
    onFocus?: () => void;
