export function checkImageFitsContainer(imageSize, containerSize, scale) {
 ...
 */
export function createConstrainPosition(imageSizeRef, containerSizeRef) {
    return (pos, currentScale) => {
