...
import { SWIPE_TIMEOUT, SWITCHING_TIMEOUT } from "./constants.js";
// Helper function to check if touch target is on gallery content (not on overlay elements)
export const isTouchOnGalleryContent = (target) => {
...
export const swipeWithSwithingAnimation = ({ swipeAction, isSwitching, setIsSwitching, }) => {
    if (isSwitching) {
        swipeAction();
    }
    else {
