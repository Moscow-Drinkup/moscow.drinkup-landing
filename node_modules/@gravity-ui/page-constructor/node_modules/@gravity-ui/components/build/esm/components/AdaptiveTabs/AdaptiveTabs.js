...
import { DEFAULT_BREAK_POINTS_CONFIG } from "./constants.js";
...
class Tab extends React.Component {
    render() {
        ...
        _jsx("div", { className: b('tab', { active, disabled }), title: typeof stringTitle === 'string' ? stringTitle : undefined, onClick: disabled ? undefined : this.onClick, children: title }));
    }
    onClick = (event) => {
...
export class AdaptiveTabs extends React.Component {
    ...
    renderSwitcher = (switcherProps) => {
        ...
        const title = (_jsxs("div", { className: b('switcher-tab-content'), children: [_jsx("span", { className: b('switcher-tab-text'), children: text }), _jsx("span", { className: b('switcher-tab-icon'), children: _jsx(Icon, { className: b('chevron-icon'), data: ChevronDown }) })] }));
        const switcherTabProps = { title, hint: text, id: 'switcher-tab' };
        const tabItemNode = _jsx(Tab, { ...switcherTabProps, active: Boolean(active) });
        return (_createElement("div", { ...triggerProps, 
    ...
    renderTabItem = (item, tabIndex) => {
        ...
        const tabNode = _jsx(Tab, { ...item, active: item.id === activeTabID });
        return (
        // eslint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions
        _jsx("div", { style: { maxWidth: items.length > 1 ? maxWidth : '100%' }, className: b('tab-container', { 'last-tab': isLastTab, 'no-overflow': noOverflow }), onClick: (e) => {
                if (!item.disabled) {
    ...
    renderSelect() {
        ...
        return (_jsx(Select, { open: isSelectOpened, onUpdate: this.onChooseTabFromSelect, options: itemsForSelect, value: [], filterable: false, renderControl: this.renderSwitcherForMoreSelect, onOpenChange: this.handleOpenSelectChange, ...moreControlProps }));
    }
    ...
    renderTabsAsSelect() {
        ...
        return (_jsx(Select, { className: b('tabs-as-select-control'), onUpdate: this.handleTabsAsSelectUpdate, options: itemsForSelect, value: activeTabID === undefined ? [] : [activeTabID], filterable: false, renderControl: this.renderSwitcherForTabsAsSelect, onOpenChange: this.handleOpenSelectChange }));
    }
    render() {
        const { items, className, size = 'm' } = this.props;
        return (_jsx("div", { ref: this.tabsRootNode, className: b({
                size: size,
                ...
                items.length > 1 ? (this.renderTabsAsSelect()) : (_jsxs(React.Fragment, { children: [_jsx("div", { ref: this.tabsListNode, className: b('tabs-list'), children: this.renderTabs() }), _jsx("div", { ref: this.selectSwitcherNode, className: b('select-switcher'), style: { insetInlineStart: this.calcSelectSwitcherInlineStartPosition() }, children: this.renderSelect() })] })) }));
    }
}
