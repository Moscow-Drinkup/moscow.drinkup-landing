...
export const NotificationsEmptyState = React.memo(function NotificationsEmptyState(props) {
    ...
    return (_jsxs("div", { className: b('empty'), children: [props.image ? props.image : _jsx(Icon, { data: nothingFoundSvg, size: 172 }), _jsxs("div", { className: b('empty-message'), children: [_jsx("div", { className: b('empty-title'), children: props.title || t('no-notifications') }), props.content ? (_jsx("div", { className: b('empty-message-content'), children: props.content })) : null] })] }));
});
