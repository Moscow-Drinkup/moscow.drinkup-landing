...
import { DRAG_THRESHOLD_PX, MAX_SCALE_DESKTOP, MIN_SCALE } from "./constants.js";
/**
 ...
 */
export function useImageZoomDesktop({ enabled, zoomState, zoomActions, constraints, }) {
     ...
     */
    const handleImageClick = React.useCallback((_event) => {
        if (!enabled) {
            return;
        }
    ...
    const handleMouseDown = React.useCallback((event) => {
        ...
        if (imageSizeRef.current.width === 0 ||
...
//# sourceMappingURL=useImageZoomDesktop.js.map
