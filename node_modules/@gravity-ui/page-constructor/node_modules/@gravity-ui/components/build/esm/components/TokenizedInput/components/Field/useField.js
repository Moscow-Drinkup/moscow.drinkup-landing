...
import { KeyCode, b } from "../../constants.js";
import { useFocusContext, useOptionsContext, useTokenizedInputComponents } from "../../context/index.js";
import { useApplyCallbackOnBlur } from "../../hooks/index.js";
export const useField = ({ selectOnClick = false, idx, fieldKey, value, onFocus, onChange, placeholder, readOnly, isNew, hidden, error, autoFocus, ...inputProps }) => {
    ...
    const classNames = React.useMemo(() => {
        ...
        const visibleSpan = b('field-visible-span', {
    ...
    const showSuggestions = Boolean(isFocused &&
        !hideSuggestions &&
        !readOnly &&
        offset !== undefined &&
        options.onSuggest &&
    ...
    const onSelectInput = React.useCallback((e) => {
        if (!inputElement) {
            return;
        }
