...
function ErrorContainer({ onRetryClick, error }) {
    const { t } = i18n_1.i18n.useTranslation();
    const { title, description } = React.useMemo(() => {
        return error && typeof error === 'object' ? error : {};
    }, [error]);
    return ((0, jsx_runtime_1.jsx)(uikit_1.Alert, { title: title || t('label_error-title'), message: description, theme: 'danger', actions: onRetryClick && [
            {
                text: t('button_retry'),
