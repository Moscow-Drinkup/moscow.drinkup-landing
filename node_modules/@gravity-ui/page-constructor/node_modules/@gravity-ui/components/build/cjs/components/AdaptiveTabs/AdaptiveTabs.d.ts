...
export declare class AdaptiveTabs<T> extends React.Component<AdaptiveTabsProps<T>, AdaptiveTabsState> {
    ...
    renderSwitcherForMoreSelect: (switcherProps: RenderControlProps) => import("react/jsx-runtime").JSX.Element;
    renderSwitcherForTabsAsSelect: (switcherProps: RenderControlProps) => import("react/jsx-runtime").JSX.Element;
    renderSwitcher: (switcherProps: RenderControlProps & {
        text: string | React.ReactNode;
        active?: boolean;
    }) => import("react/jsx-runtime").JSX.Element;
    renderTabs: () => import("react/jsx-runtime").JSX.Element[];
    renderTabItem: (item: TabItem<T>, tabIndex: number) => import("react/jsx-runtime").JSX.Element;
    ...
    renderTabsAsSelect(): import("react/jsx-runtime").JSX.Element;
