...
exports.useGalleryContext = exports.GalleryContextProvider = void 0;
...
const GalleryContextProvider = function GalleryContextProvider({ children, onViewInteractionChange, onTap }) {
    const value = React.useMemo(() => ({
        onTap,
        onViewInteractionChange,
    }), [onTap, onViewInteractionChange]);
    return (0, jsx_runtime_1.jsx)(GalleryContext.Provider, { value: value, children: children });
};
exports.GalleryContextProvider = GalleryContextProvider;
/**
