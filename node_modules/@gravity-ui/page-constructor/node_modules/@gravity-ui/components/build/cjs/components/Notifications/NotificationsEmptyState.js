...
exports.NotificationsEmptyState = React.memo(function NotificationsEmptyState(props) {
    const { t } = index_1.i18n.useTranslation();
    return ((0, jsx_runtime_1.jsxs)("div", { className: b('empty'), children: [props.image ? props.image : (0, jsx_runtime_1.jsx)(uikit_1.Icon, { data: nothingFoundSvg, size: 172 }), (0, jsx_runtime_1.jsxs)("div", { className: b('empty-message'), children: [(0, jsx_runtime_1.jsx)("div", { className: b('empty-title'), children: props.title || t('no-notifications') }), props.content ? ((0, jsx_runtime_1.jsx)("div", { className: b('empty-message-content'), children: props.content })) : null] })] }));
});
//# sourceMappingURL=NotificationsEmptyState.js.map
