...
const difference_1 = __importDefault(require("lodash/difference.js"));
const throttle_1 = __importDefault(require("lodash/throttle.js"));
...
class Tab extends React.Component {
    render() {
        ...
        (0, jsx_runtime_1.jsx)("div", { className: b('tab', { active, disabled }), title: typeof stringTitle === 'string' ? stringTitle : undefined, onClick: disabled ? undefined : this.onClick, children: title }));
    }
    onClick = (event) => {
...
class AdaptiveTabs extends React.Component {
    static defaultProps = {
    ...
    breakpoints;
    tabMaxWidthInPercentsForScreenSize;
    throttledHandleResize;
    resizeObserver;
    tabItemPaddingRight = 0;
    switcherWidth = 0;
    ...
    dimensionsWereInitiallyCollected = true;
    selectSwitcherNode = React.createRef();
    tabsRootNode = React.createRef();
    tabsListNode = React.createRef();
    get activeTab() {
     ...
     */
    wasItemsListUpdated = (currentItems, prevItems) => {
    ...
    onChooseTabFromSelect = (tabChosenFromSelectIds) => {
    ...
    renderSwitcherForMoreSelect = (switcherProps) => {
    ...
    renderSwitcherForTabsAsSelect = (switcherProps) => {
        const { items } = this.props;
    ...
    renderSwitcher = (switcherProps) => {
        ...
        const title = ((0, jsx_runtime_1.jsxs)("div", { className: b('switcher-tab-content'), children: [(0, jsx_runtime_1.jsx)("span", { className: b('switcher-tab-text'), children: text }), (0, jsx_runtime_1.jsx)("span", { className: b('switcher-tab-icon'), children: (0, jsx_runtime_1.jsx)(uikit_1.Icon, { className: b('chevron-icon'), data: icons_1.ChevronDown }) })] }));
        const switcherTabProps = { title, hint: text, id: 'switcher-tab' };
        const tabItemNode = (0, jsx_runtime_1.jsx)(Tab, { ...switcherTabProps, active: Boolean(active) });
        return ((0, react_1.createElement)("div", { ...triggerProps, 
            // eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex
            tabIndex: 0, key: "switcher", className: b('tab-container', { 'switcher-tab': true }), ref: ref }, wrapTo ? wrapTo(undefined, tabItemNode, undefined) : tabItemNode));
    };
    renderTabs = () => {
        const { items } = this.props;
        const { firstHiddenTabIndex, tabChosenFromSelectId } = this.state;
    ...
    renderTabItem = (item, tabIndex) => {
        ...
        const tabNode = (0, jsx_runtime_1.jsx)(Tab, { ...item, active: item.id === activeTabID });
        return (
        // eslint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions
        (0, jsx_runtime_1.jsx)("div", { style: { maxWidth: items.length > 1 ? maxWidth : '100%' }, className: b('tab-container', { 'last-tab': isLastTab, 'no-overflow': noOverflow }), onClick: (e) => {
                if (!item.disabled) {
                    this.onTabClick(item.id, e);
                }
            }, children: wrapTo ? wrapTo(item, tabNode, tabIndex) : tabNode }, item.id));
    };
    renderSelect() {
        const activeTabID = this.activeTab;
        ...
        return ((0, jsx_runtime_1.jsx)(uikit_1.Select, { open: isSelectOpened, onUpdate: this.onChooseTabFromSelect, options: itemsForSelect, value: [], filterable: false, renderControl: this.renderSwitcherForMoreSelect, onOpenChange: this.handleOpenSelectChange, ...moreControlProps }));
    }
    handleTabsAsSelectUpdate = (ids) => {
        const tabId = ids[0];
        this.selectTab(tabId);
        this.setState({ tabChosenFromSelectId: tabId });
    };
    handleOpenSelectChange = (isSelectOpened) => {
    ...
    renderTabsAsSelect() {
        ...
        return ((0, jsx_runtime_1.jsx)(uikit_1.Select, { className: b('tabs-as-select-control'), onUpdate: this.handleTabsAsSelectUpdate, options: itemsForSelect, value: activeTabID === undefined ? [] : [activeTabID], filterable: false, renderControl: this.renderSwitcherForTabsAsSelect, onOpenChange: this.handleOpenSelectChange }));
    }
    render() {
        const { items, className, size = 'm' } = this.props;
        return ((0, jsx_runtime_1.jsx)("div", { ref: this.tabsRootNode, className: b({
                size: size,
                visible: this.state.dimensionsWereCollected,
            }, [className]), children: (this.state.currentContainerWidthName === SMALL_CONTAINER_WIDTH_NAME ||
                this.state.firstHiddenTabIndex === 0) &&
                items.length > 1 ? (this.renderTabsAsSelect()) : ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { ref: this.tabsListNode, className: b('tabs-list'), children: this.renderTabs() }), (0, jsx_runtime_1.jsx)("div", { ref: this.selectSwitcherNode, className: b('select-switcher'), style: { insetInlineStart: this.calcSelectSwitcherInlineStartPosition() }, children: this.renderSelect() })] })) }));
    }
}
exports.AdaptiveTabs = AdaptiveTabs;
//# sourceMappingURL=AdaptiveTabs.js.map
