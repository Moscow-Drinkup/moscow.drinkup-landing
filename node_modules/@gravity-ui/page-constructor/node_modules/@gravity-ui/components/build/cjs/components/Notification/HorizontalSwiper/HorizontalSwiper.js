...
class HorizontalSwiper {
    ...
    onTouchMove(event) {
        ...
        const touchMoveX = (event.type === 'mousemove'
            ? event.screenX
            : event.changedTouches[0].screenX) - (this.touchStartX ?? 0);
    ...
    onTouchEnd(event) {
        ...
        if (absX > this.thresholdX) {
            ...
            if (this.swipedHorizontal) {
                if (x < 0) {
                    // Left swipe.
                    if ((this.velocityX ?? 0) < -this.opts.velocityThreshold ||
...
//# sourceMappingURL=HorizontalSwiper.js.map
