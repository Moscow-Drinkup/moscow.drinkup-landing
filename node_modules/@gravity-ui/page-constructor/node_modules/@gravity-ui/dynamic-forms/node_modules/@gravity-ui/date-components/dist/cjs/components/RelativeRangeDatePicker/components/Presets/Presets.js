...
exports.SIZE_TO_ITEM_HEIGHT = void 0;
...
function Presets({ className, size = 'm', minValue, withTime, onChoosePreset, presetTabs, }) {
    ...
    const tabs = react_1.default.useMemo(() => {
        return (0, utils_1.filterPresetTabs)(presetTabs !== null && presetTabs !== void 0 ? presetTabs : (0, utils_1.getDefaultPresetTabs)({ withTime, t }), { minValue });
