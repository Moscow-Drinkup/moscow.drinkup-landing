...
> ⚠️ **Deprecated.** `slider-old-block` is deprecated and will be removed in a future major release. Use [`slider-block`](./Slider.md) (the `Slider` block, built on Swiper) for new and existing pages.
