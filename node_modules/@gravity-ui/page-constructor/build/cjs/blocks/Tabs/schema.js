...
const schema_2 = require("../../sub-blocks/Content/schema.js");
...
exports.TabsBlock = {
    'tabs-block': {
        ...
        properties: {
            ...
            ...common_1.BlockHeaderProps,
            tabsColSizes: common_1.containerSizesArray.reduce((acc, size) => ({ ...acc, [size]: common_1.sizeNumber }), {}),
            direction: {
                type: 'string',
