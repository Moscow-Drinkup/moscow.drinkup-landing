import { BlockDecorationProps, BlockDecorator, CustomConfig } from "../../models/index.js";
...
export declare const addCustomDecorator: (decorators: BlockDecorator[], custom?: CustomConfig) => {
    ...
    blocks?: import("../../models/index.js").CustomItems;
    subBlocks?: import("../../models/index.js").CustomItems;
    headers?: import("../../models/index.js").CustomItems;
    navigation?: import("../../models/index.js").CustomItems;
    loadable?: import("../../models/index.js").LoadableConfig;
};
