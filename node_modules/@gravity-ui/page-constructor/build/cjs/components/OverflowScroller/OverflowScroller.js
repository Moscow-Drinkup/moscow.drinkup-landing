...
class OverflowScroller extends React.Component {
    state = {
        arrows: [],
        scrollValue: 0,
    };
    ...
    render() {
        ...
        return ((0, jsx_runtime_1.jsxs)("div", { className: b('container', {
                'padding-left': paddingLeft,
                'padding-right': paddingRight,
            }), children: [(0, jsx_runtime_1.jsx)("div", { className: b(null, className), ref: this.containerRef, children: (0, jsx_runtime_1.jsx)("div", { className: b('wrapper'), style: wrapperStyle, ref: this.wrapperRef, children: children }) }), arrows.map((direction) => ((0, jsx_runtime_1.jsx)("button", { className: b('arrow', { type: direction }, arrowClassName), onClick: (e) => this.handleScrollClick(e, direction), "aria-label": (0, i18n_1.i18n)(direction), children: (0, jsx_runtime_1.jsx)(__1.ToggleArrow, { size: arrowSize, type: 'horizontal', iconType: "navigation" }) }, direction)))] }));
    }
    // eslint-disable-next-line @typescript-eslint/member-ordering, react/sort-comp
    checkOverflow = (0, debounce_1.default)(() => {
