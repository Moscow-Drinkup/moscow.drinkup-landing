...
import { checkYoutubeVideos } from "./utils.js";
import { isYoutubePlayerInstance } from "./utils/youtube.js";
...
export const ReactPlayerBlock = React.forwardRef((props, originRef) => {
    ...
    const playIcon = React.useMemo(() => {
        ...
        return (_jsx(VideoButton, { ...playButton, theme: theme || PlayButtonThemes.Blue, type: type || PlayButtonType.Default }));
    }, [playButton]);
    const changeMute = React.useCallback((isMuted) => {
        if (isMuted &&
            playerRef &&
    ...
    const onReady = React.useCallback((player) => {
        setPlayerRef(player);
    ...
    return (_jsx("div", { className: b({
            ...
            'auto-ratio': autoRatio,
                    ...
                    } }), controls === MediaVideoControlsType.Custom && (_jsx(CustomBarControls, { className: customBarControlsClassName, mute: {
                        isMuted: muted,
                        changeMute: (event) => {
