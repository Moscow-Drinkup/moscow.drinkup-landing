import { calculateMapParamsWithMarginAndZoom, parseMargin } from "./utils.js";
var GeoObjectTypes;
    ...
    recalcZoomAndCenter(props) {
        ...
        switch (true) {
            case hasAreaMargin && hasZoom:
                ...
                newMapParams = calculateMapParamsWithMarginAndZoom([leftTop, rightBottom], zoom, parsedAreaMargin, containerSize);
                break;
            case hasAreaMargin:
