...
export const calcPixelBounds = ([leftTop, rightBottom], zoom, containerSize) => {
...
export const calculateMapParamsWithMarginAndZoom = ([leftTop, rightBottom], zoom, areaMargin, containerSize) => {
    const utils = window.ymaps.util.bounds;
    // calculate pixel bounds with current zoom
    let [[leftPx, topPx], [rightPx, bottomPx]] = calcPixelBounds([leftTop, rightBottom], zoom, containerSize);
    ...
    [[leftPx, topPx], [rightPx, bottomPx]] = calcPixelBounds([leftTop, rightBottom], newZoom, containerSize);
