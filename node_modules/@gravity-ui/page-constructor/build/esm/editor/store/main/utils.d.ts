import { ConstructorBlock, PageContent } from "../../../models/index.js";
import { EditorBlockId } from "./reducer.js";
...
export declare const addEditorProps: (content: PageContent) => {
    ...
    menu?: import("../../../index.js").Menu;
    background?: import("../../../index.js").ThemedMediaProps;
};
