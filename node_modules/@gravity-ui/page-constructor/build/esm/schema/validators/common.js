...
export function withTheme(value) {
    return {
        oneOf: [
            {
                ...value,
            ...
            },
            {
                ...
                properties: Object.values(Theme).reduce((result, themeName) => ({
                    ...result,
                    [themeName]: value,
                }), {}),
                optionName: 'themes',
    ...
    visible: {
        oneOf: [
            ...
            },
            {
                type: 'object',
                additionalProperties: false,
                properties: containerSizesArray.reduce((acc, size) => ({ ...acc, [size]: { type: 'boolean' } }), {}),
            },
        ],
    },
    resetPaddings: {
