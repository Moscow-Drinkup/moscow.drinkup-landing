...
export const worldToScreen = (point, transform) => ({
...
export function fitToViewport(bounds, viewport, padding = VIEWPORT_PADDING) {
...
export function zoomAtPoint(transform, factor, point, minScale, maxScale) {
