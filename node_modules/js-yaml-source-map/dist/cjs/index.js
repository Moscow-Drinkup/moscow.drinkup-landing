            ...
            if (kind === "scalar") {
                ...
                this.iterFragments(pathName, (fragment) => {
                    ...
                    if (this._path.length === 1) {
                        ...
                        newFragment.children.push(Object.assign(Object.assign({}, fragment), { path: fragment.path.slice(pathName.length + 1) }));
                ...
                this.iterFragments(pathName, (fragment) => {
                    ...
                    if (this._path.length === 1) {
                        ...
                        // otherwise create a new fragment with correct children
                        newFragment.children.push(Object.assign(Object.assign({}, fragment), { path: index.toString() }));
                        newFragment.line = fragment.line;
                        newFragment.position = fragment.position;
                        newFragment.lineStart = fragment.lineStart;
                    }
